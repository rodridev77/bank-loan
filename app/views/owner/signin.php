        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form method="post" id="signin-form">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="key" id="signin-secret-key" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-block admin-auth-btn" onclick="signinOwner();">Autenticar</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
