...
echo BASE_URL ?>/app/views/templates/adminlte/plugins/fontawesome-free/css/all.min.css">
    <!-- Theme style -->
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="<?= BASE_URL ?>/app/views/templates/adminlte/dist/img/AdminLTELogo.png"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?= BASE_URL ?>/app/views/templates/adminlte/dist/img/avatar-admin.png"
